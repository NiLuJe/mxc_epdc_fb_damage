...
typedef struct
{
	// Will be set to the amount of lost events when the buffer isn't drained fast enough
	unsigned int             overflow_notify;
	// Will be set to the amount of damage events in the (kernel) buffer *including* this one.
